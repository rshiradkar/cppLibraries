...
${UNCRUSTIFYBIN} -c /mnt/projects/CSE_BME_AXM788/home/soumya/DEV/ANTs/build/ITKv4/Utilities/Maintenance/uncrustify_itk.cfg -l CPP -f ${file} | sed 's/  *##  */##/g' | sed 's/#  */#/g' > ${file}_uncrustify
...
KWSTYLE_EXECUTABLE-NOTFOUND -xml /mnt/projects/CSE_BME_AXM788/home/soumya/DEV/ANTs/build/ITKv4-build/Utilities/KWStyle/ITK.kws.xml -v -o /mnt/projects/CSE_BME_AXM788/home/soumya/DEV/ANTs/build/ITKv4/Utilities/KWStyle/ITKOverwrite.txt -gcc $file > ${KWERROS}
...
if [ -f ${KWERROS} ]; then
  ...
  if [ ${skipuncrustify} == "y" ]; then
    ${UNCRUSTIFYBIN} -c /mnt/projects/CSE_BME_AXM788/home/soumya/DEV/ANTs/build/ITKv4/Utilities/Maintenance/uncrustify_itk.cfg -l CPP -f ${file} -o ${KWERROS}_skip_uncrustify
  fi
